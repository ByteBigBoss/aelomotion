    ...
    <div className="con">
      ...
      <div className="flex flex-col items-start mt-8 px-4 gap-4 pb-[40px]">
        ...
        <div>
          ...
          <span>By using will-change, the browser knows in advance which properties are going to change and can prepare by creating a separate layer for that element, reducing the chances of layout shifts and rendering issues.</span>
        </div>
        <div>
          <div className="text-[1.25rem] font-bold">Less Jank</div>
          <span>Especially important for animations that might cause the browser to re-render or reflow elements on the page, reducing visual glitches during the animation.</span>
        </div>
      </div>
    </div>
  );
